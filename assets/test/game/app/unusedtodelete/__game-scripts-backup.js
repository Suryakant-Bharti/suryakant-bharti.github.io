...
WeChat.openId = "oGbVCtzgR1JSDfCKP5wxqjLKF_NE", WeChat.GAME_DOMAIN = "http://api.24haowan.com/", WeChat.GAME_ID = 3, WeChat.diamond = -1, WeChat.TIMEOUT = 3e3, WeChat.firstComeToday = !1, WeChat.appId = "wxef721b05e2002815", WeChat.userInfoData = null, WeChat.errorCallbackFunction = function(e, t, a) {
    console.error("XHR:" + e + ", textStatus:" + t + ", errorThrown:" + a), "timeout" === t && self.gameEntity.script.hintText.hint("亲！您的网络好像出问题了哦！")
...
Revive.freeRevive = !1, Revive.isRevivePage = !1, Revive.reviveDiamondCost = -1, Revive.reviveTimes = 0, Revive.useDiamondReviveTimes = 0, Revive.pivot = -1, Revive.prototype.initialize = function() {
    ...
    Revive.isRevivePage = !0, GameManager.GAME_PAUSE = !0, this.app.fire("game:pause"), this.app.fire("game:postCommitDiamond"), this.gameEntity.script.htmlAndCss.fadeInDown($("#revive-container")), this.gameEntity.script.htmlAndCss.overlayFadeIn($("#bg-overlay"))
    ...
    this.clickable = !1, Revive.reviveDiamondCost = parseInt(Revive.pivot, 10) * Math.pow(2, Revive.useDiamondReviveTimes), $("#revive-container #diamond-revive-btn #diamond-count").text(Revive.reviveDiamondCost), $.ajax({
        ...
        timeout: WeChat.TIMEOUT,
        success: function(i) {
            i = JSON.parse(i), 0 === i.code && (i.msg === !0 ? ($("#revive-container #text-info").text("复活后可继续进行游戏，可获得更高分哦123"), $("#revive-container #free-revive-btn").hide(), $("#revive-container #share-revive-btn").show(), $("#revive-container #diamond-revive-btn").css({
                transform: "translateX(5%)"
            }).show()) : ($("#revive-container #text-info").text("复活后可继续进行游戏，可获得更高分哦123"), $("#revive-container #free-revive-btn").hide(), $("#revive-container #share-revive-btn").hide(), $("#revive-container #diamond-revive-btn").css({
