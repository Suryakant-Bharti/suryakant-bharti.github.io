...
Road.attributes.add("Road01", {
    ...
    for (var t = ["TreeSmallBlueMaterial", "TreeSmallGreenMaterial", "TreeSmallPinkMaterial", "TreeSmallPurpleMaterial", "TreeSmallYellowMaterial"], 
        e = ["TreeMiddleBlueMaterial", "TreeMiddleGreenMaterial", "TreeMiddlePinkMaterial", "TreeMiddlePurpleMaterial", "TreeMiddleYellowMaterial"], 
        i = ["TreeLargeBlueMaterial", "TreeLargeGreenMaterial", "TreeLargePinkMaterial", "TreeLargePurpleMaterial", "TreeLargeYellowMaterial"], 
        r = 0, a = t.length; a > r; r++) this.treeSmallMaterialArray.push(this.app.assets.findByTag(t[r])[0]), this.treeMiddleMaterialArray.push(this.app.assets.findByTag(e[r])[0]), 
        this.treeLargeMaterialArray.push(this.app.assets.findByTag(i[r])[0])
...
Camera.attributes.add("animalEntity", {
    ...
    this.showTimePos = new pc.Vec3(this.initialX, this.initialY - 4, this.initialZ), this.initialAngle = new pc.Quat(-35, 0, 0), this.cameraTargetPos = new pc.Vec3, this.deadPosDis = new pc.Vec3(0, 0, -10), this.app.on("ball:onBallPosChange", this.changePos, this), this.app.on("game:reset", this.reset, this), this.app.on("game:start", this.onGameStart, this), this.app.on("game:gameover", this.onGameover, this)
    ...
    this.entity.setPosition(this.initialX, this.initialY, this.initialZ), this.entity.setEulerAngles(-38, 0, 0)
}, Camera.prototype.reset = function() {
    this.entity.setPosition(this.initialX, this.initialY, this.initialZ), this.entity.setEulerAngles(-38, 0, 0)
}, Camera.prototype.changePos = function() {
    var t = this.animalEntity.getPosition();
    t.x = this.initialX, t.y += this.initialY + 4, t.z += this.initialZ - 4, this.entity.setPosition(t)
};
...
WeChat.openId = "oGbVCtzgR1JSDfCKP5wxqjLKF_NE", WeChat.GAME_DOMAIN = "http://api.24haowan.com/", WeChat.GAME_ID = 3, WeChat.diamond = 0, WeChat.TIMEOUT = 3e3, WeChat.firstComeToday = !1, WeChat.appId = "wxef721b05e2002815", WeChat.userInfoData = null, WeChat.prototype.initialize = function() {
...
Revive.freeRevive = !1, Revive.isRevivePage = !1, Revive.reviveDiamondCost = -1, Revive.reviveTimes = 0, Revive.useDiamondReviveTimes = 0, Revive.pivot = 10, Revive.prototype.initialize = function() {
    this.gameEntity = this.app.root.findByName("Game"), this.clickable = !0, this.loadReviveHtml(), this.loadReviveCss(), $("#revive-container").hide(), this.initReviveTimeOnServer(), this.app.on("game:uiRevive", this.onUiRevive, this), this.app.on("game:onReviveShareSuccess", this.onReviveShareSuccess, this), this.app.on("game:reset", this.reset, this), this.app.on("game:postCommitDiamondSuccess", this.getFreeReviveTimes, this), 
    $("#revive-container #close-btn").on("tap", function() {
    ...
    }.bind(this)), $("#revive-container #close-btn").on("mousedown", function() {
        this.clickable && (this.gameEntity.script.htmlAndCss.fadeOutUp($("#revive-container")), this.gameEntity.script.htmlAndCss.overlayFadeOut($("#bg-overlay")), Revive.isRevivePage = !1, this.app.fire("game:gameover"))
    ...
    }.bind(this)), $("#revive-container #free-revive-btn").on("mousedown", function() {
        this.clickable && this.reviveBtnOnClick()
    }.bind(this)), $("#revive-container #diamond-revive-btn").on("tap", function() {
        this.clickable && this.diamondReviveBtnOnClick()
    }.bind(this)), $("#revive-container #diamond-revive-btn").on("mousedown", function() {
        this.clickable && this.diamondReviveBtnOnClick()
    }.bind(this))
    ...
    var e = this,
        i = (new Date).Format("yyyy-MM-dd hh:mm:ss");
    this.clickable = !1, 
    e.app.fire("game:onRevive"), 
    e.gameEntity.script.htmlAndCss.fadeOutUp($("#revive-container")), 
    e.gameEntity.script.htmlAndCss.overlayFadeOut($("#bg-overlay")), 
    WeChat.diamond -= Revive.reviveDiamondCost, e.app.fire("game:costDiamond"), 
    Revive.useDiamondReviveTimes++, 
    Revive.freeRevive = !1, 
    Revive.isRevivePage = !1, 
    Revive.reviveTimes++
}, Revive.prototype.reviveBtnOnClick = function() {
    var e = this;
    this.clickable = !0, 
    (this.app.fire("game:onRevive"), e.gameEntity.script.htmlAndCss.fadeOutUp($("#revive-container")), e.gameEntity.script.htmlAndCss.overlayFadeOut($("#bg-overlay")), Revive.freeRevive = !1, Revive.isRevivePage = !1, Revive.reviveTimes++)
    ...
    //window.alert(WeChat.diamond),
    Revive.isRevivePage = !0, GameManager.GAME_PAUSE = !0, this.app.fire("game:pause"), this.checkIfHasFreeReviveOrNot()

    //GameManager.GAME_PAUSE = !0, this.app.fire("game:gameover")
...
this.gameEntity.script.htmlAndCss.fadeInDown($("#revive-container"))
        // $("#revive-container #text-info").text("您已获得免费复活，点击复活继续游戏。"), 
        // $("#revive-container #free-revive-btn").show(), 
        // $("#revive-container #share-revive-btn").hide(), 
        // $("#revive-container #diamond-revive-btn").hide()
    this.clickable = !0, Revive.reviveDiamondCost = parseInt(Revive.pivot, 10) * Math.pow(2, Revive.useDiamondReviveTimes), 
    $("#revive-container #diamond-revive-btn #diamond-count").text(Revive.reviveDiamondCost)

// setTimeout(function() {
//                 ($("#revive-container #text-info").text("复活后可继续进行游戏，可获得更高分哦"), 
//                     $("#revive-container #free-revive-btn").hide(), 
//                     $("#revive-container #share-revive-btn").show(), 
//                     $("#revive-container #diamond-revive-btn").css({
